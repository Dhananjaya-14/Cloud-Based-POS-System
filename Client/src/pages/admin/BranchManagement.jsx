  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "#F4F6F9" }}>
      ...
      <div style={{ flex: 1, marginLeft: "240px" }}>
        ...
        >
          <h2 style={{ fontSize: "26px", margin: 0, fontWeight: "500" }}>Branch Management</h2>
                ...
                notifications.map((notification) => (
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor:
                        notification.type === 'delete' ? '#FEF2F2' :
                        notification.type === 'update' ? '#EFF6FF' : '#F0FDF4',
                      transition: 'background 0.2s',
                      cursor: 'default',
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.backgroundColor =
                        notification.type === 'delete' ? '#FEE2E2' :
