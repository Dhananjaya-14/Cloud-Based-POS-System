    ...
    try {
      ...
      if (manager?.u_id) {
        const {
          firstName,
          lastName
        } = splitFullName(form.managerName, manager?.u_fname || "", manager?.u_lname || "");
      ...
      // Set success message
      setSuccessMessage(`âœ… Branch "${nextBranch.B_name}" updated successfully!`);
  ...
  return <div style={{
    ...
    minHeight: "100vh"
      ...
      marginLeft: "240px"
        ...
        {isSuperAdmin ? <Header title={t("company_admin.branch_management", "Branch Management")} /> : <Header />}
        ...
        padding: "0 20px 20px"
          ...
          position: "relative"
            ...
            <button type="button" onClick={goToProfile} style={{
            display: "inline-flex",
            alignItems: "center",
            gap: "8px",
            border: "none",
            ...
            marginBottom: "20px"
              ...
              <FaArrowLeft />{t("company_admin.back_to_branch_profile", "Back to Branch Profile")}</button>
            ...
            fontSize: "40px",
            lineHeight: 1
          }}>{t("company_admin.edit_branch_profile", "Edit Branch Profile")}</h1>
            ...
            }}>{t("company_admin.edit_profile", "Edit Profile")}</span>
            </div>
            ...
            textAlign: "center",
            marginTop: "32px"
          }}>{error}</p> : <form onSubmit={handleSave}>
                <div style={{
              display: "grid",
              ...
              marginTop: "34px"
                ...
                gap: "14px 18px"
                    ...
                    <EditableField label={t("fields.branch_name", "Branch Name")} name="B_name" value={form.B_name} onChange={handleChange} />
                    <EditableField label={t("fields.branch_admin_name", "Branch Admin Name")} name="managerName" value={form.managerName} onChange={handleChange} />
                    <EditableField label={t("fields.email", "Email")} name="B_email" value={form.B_email} onChange={handleChange} />
                    <EditableField label={t("fields.username", "Username")} name="username" value={form.username} onChange={handleChange} />
                    <EditableField label={t("fields.address", "Address")} name="B_address" value={form.B_address} onChange={handleChange} />
                    <EditableField label={t("fields.password", "Password")} name="password" value={form.password} onChange={handleChange} type="password" placeholder={t("company_admin.enter_new_password", "Enter new password")} />
                    <div style={{
                  display: "grid",
                  gridColumn: "1 / -2",
                  ...
                  alignItems: "end"
                      ...
                      <EditableField label={t("fields.contact_number", "Contact Number")} name="B_conNo" value={form.B_conNo} onChange={handleChange} />
              ...
              flexWrap: "wrap"
                ...
                fontSize: "1.05rem"
                    ...
                    <FaSave /> {saving ? t("buttons.saving", "Saving...") : t("buttons.save", "Save")}
                  </button>
                ...
                fontSize: "1.05rem"
                    ...
                    <FaTimes />{t("company_admin.cancel", t("buttons.cancel", "Cancel"))}</button>
                </div>
              </form>}
          </div>
        </div>
...
return <div>
      ...
      <input name={name} value={value} onChange={onChange} type={type} placeholder={placeholder} style={inputBase} />
    </div>;
};
