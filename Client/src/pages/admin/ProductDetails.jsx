  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        setLoading(true);
        setError("");
        const [productData, categoryData, branchData] = await Promise.all([getProductById(productId), getCategories().catch(() => []), getBranches().catch(() => [])]);
      ...
      marginLeft: "240px"
        ...
        padding: "18px 20px 24px"
          ...
          marginBottom: "10px"
            ...
            <FaArrowLeft />
            <span>{t("company_admin.view_details", "View details")}</span>
          </button>
          ...
          alignItems: "start"
            ...
            <div>
              ...
              color: "#475569",
              fontSize: "14px"
            }}>{t("company_admin.loading_product_details", "Loading product details...")}</div> : error ? <div style={{
              color: "#B91C1C",
              fontSize: "14px",
              marginBottom: "10px"
            }}>{error}</div> : <>
                  ...
                  marginBottom: "10px"
                    ...
                    position: "relative"
                      ...
                      paddingRight: "30px"
                          ...
                          <option value="General">{t("company_admin.general", "General")}</option>
                ...
                marginTop: "10px"
                  ...
                  marginBottom: "10px"
                      ...
                      paddingRight: "30px"
                          ...
                          <option value="">{t("company_admin.n_a", "N/A")}</option>
                        </select>
                      </div>
                    </div>
            ...
            paddingTop: "34px"
              ...
              marginBottom: "22px"
                ...
                <div style={cardStyle}>
                  ...
                  marginTop: "12px"
                    ...
                    <input placeholder={t("company_admin.add_new_add_on", "Add new add-on...")} value={newAddOn} onChange={e => setNewAddOn(e.target.value)} style={{
                    flex: 1,
                    height: "26px",
                    borderRadius: "8px",
                    border: "1px solid #D6E2EF",
                    ...
                    fontWeight: "700",
                    cursor: "pointer"
                  }}>{t("company_admin.add", "+ Add")}</button>
                  </div>
                </div>
                ...
                <div style={cardStyle}>
                  ...
                  marginTop: "12px"
                    ...
                    <input placeholder={t("company_admin.add_new_station", "Add new station...")} value={newStation} onChange={e => setNewStation(e.target.value)} style={{
                    flex: 1,
                    height: "26px",
                    borderRadius: "8px",
                    border: "1px solid #D6E2EF",
              ...
              marginTop: "24px"
                ...
                fontWeight: "700"
              }}>{t("company_admin.delete_product", "Delete Product")}</button>}
          ...
          {isDeletePage && <div style={modalOverlayStyle}>
              ...
              padding: "18px 20px 10px"
                ...
                color: "#111827",
                fontWeight: "800"
              }}>{t("company_admin.delete_product", "Delete Product?")}</h3>
                  <p style={{
                margin: "8px 0 0",
                fontSize: "12px",
                lineHeight: 1.45,
                color: "#111827"
              }}>{t("company_admin.are_you_sure_you_want_to_delete", "Are you sure you want to delete '")}{form.pro_name || "this product"}{t("company_admin.this_action_cannot_be_undone_and_will_re", "'? This action cannot be undone and will remove the product from all ups menus and historical reports.")}</p>
                </div>

                <div style={{
              padding: "0 20px 12px"
            }}>
                  <div onClick={() => setDeleteOption("branch")} style={{
                ...
                background: deleteOption === "branch" ? "#EFF6FF" : "#fff"
                  ...
                  alignItems: "center",
                  gap: "8px",
                  marginBottom: deleteOption === "branch" ? "8px" : 0
                }}>
                      ...
                      fontWeight: "700",
                      color: "#111827"
                    }}>{t("company_admin.delete_from_specific_branch", "Delete from specific branch")}</div>
                        <div style={{
                      fontSize: "10px",
                      color: "#6B7280"
                    }}>{t("company_admin.stays_in_admin_panel_and_other_branches", "Stays in admin panel and other branches")}</div>
                      </div>
                    </div>

                    {deleteOption === "branch" && <select value={selectedBranchId} onChange={e => setSelectedBranchId(e.target.value)} style={{
                  width: "100%",
                  height: "30px",
                  borderRadius: "6px",
                  ...
                  <div onClick={() => setDeleteOption("complete")} style={{
                ...
                background: deleteOption === "complete" ? "#FEF2F2" : "#fff"
                  ...
                  gap: "8px"
                      ...
                      fontWeight: "700",
                      color: "#EF4444"
                    }}>{t("company_admin.delete_completely_from_system", "Delete completely from system")}</div>
                        <div style={{
                      fontSize: "10px",
                      color: "#6B7280"
                    }}>{t("company_admin.removes_from_all_branches_permanently", "⚠️ Removes from ALL branches permanently")}</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              padding: "0 20px 16px"
                ...
                color: "#111827"
                    ...
                    <span>{t("company_admin.i_understand_that_this_action_is_permane", "I understand that this action is permanent.")}</span>
                  </label>
                </div>
