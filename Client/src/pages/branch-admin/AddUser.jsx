  ...
  useEffect(() => {
    const loadOptions = async () => {
      try {
        ...
        setFormData(prev => ({
          ...prev,
          role: prev.role || (allowedRoles?.length > 0 ? String(allowedRoles[0].role_id) : ""),
    ...
    minHeight: "100vh"
      ...
      marginLeft: "240px"
        ...
        padding: "18px 24px 28px"
					...
					<Link to="/branch-admin/users" style={{
          textDecoration: "none"
        }}>
						<div style={{
            display: "inline-flex",
          ...
          margin: "0 auto"
            ...
            fontWeight: "700",
            color: "#111"
          }}>{t("branch_admin.add_new_user", "Add New User")}</h1>
            ...
            alignItems: "start"
              ...
              gap: "18px"
                ...
                pointerEvents: isLoadingOptions ? "none" : "auto"
                  ...
                  color: "#5E5E5E",
                  fontSize: "13px"
                }}>{t("branch_admin.loading_roles_and_branches", "Loading roles and branches...")}</p>}
      ...
      zIndex: 9999
        ...
        justifyContent: "center"
          ...
          fontWeight: "600",
          color: "#0E5BA8"
        }}>{t("branch_admin.new_user_has_been", "New User has been")}<br />{t("branch_admin.added", "Added")}<br />{t("branch_admin.successfully", "Successfully")}</h2>
          ...
          fontWeight: "500",
          cursor: "pointer"
        }}>{t("branch_admin.countinue", "Countinue")}</button>
					</div>
				</div>}
