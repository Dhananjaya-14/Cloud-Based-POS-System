...
const doc = new jsPDF();
    ...
    printWindow.document.write('<!DOCTYPE html>' +
      ...
      '<head>' +
      '<meta charset="UTF-8" />' +
      '<title>' + t('branch_admin.raw_material_stock_report', 'Raw Material Stock Report') + '<\/title>' +
      ...
      '</head>' +
      '<body>' +
      '<h2>' + t('branch_admin.raw_material_stock_report', 'Raw Material Stock Report') + '</h2>' +
